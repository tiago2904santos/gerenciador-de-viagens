...
```sql
SELECT count(*) FROM ordens_servico_ordemservico WHERE area_id IS NULL;
```
...
**Volta:** `migrate ordens_servico 0011_os_periodo_ordenado`. Nenhum dado muda.
"""
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("ordens_servico", "0011_os_periodo_ordenado"),
