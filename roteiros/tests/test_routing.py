...
class RoteirosRoutingTests(TestCase):
    ...
    def test_reordenar_destinos_marca_rota_desatualizada(self):
        ...
        # `DB-08`: reordenar do jeito que a produção reordena.
        #
        # Este teste trocava as posições no lugar (`d0.ordem, d1.ordem = 1, 0`
        ...
        # destinos é `editor_state_builder._salvar_roteiro_avulso_from_roteiro_state`, que faz `destinos.all().delete()` e
        ...
        # recalcula a assinatura a partir dos destinos atuais, não de sinal de
        # `save()` — a ordem final é a mesma pelos dois caminhos.
