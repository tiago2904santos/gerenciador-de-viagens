...
| `BE-16` 🟡 PARCIAL | Paginação fechada em 15 pontos; exclusões de entidade adotam `core.deletion` e transformam `PROTECT` em erro de domínio, com remoções internas deliberadamente excluídas; falta retorno | 2 |
