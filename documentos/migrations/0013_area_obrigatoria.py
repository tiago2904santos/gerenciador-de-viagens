...
```sql
SELECT count(*) FROM documentos_documentoartefato WHERE area_id IS NULL;
```
...
**Volta:** `migrate documentos 0012_alter_documentoartefato_options_and_more`. Nenhum dado muda.
"""
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("documentos", "0012_alter_documentoartefato_options_and_more"),
