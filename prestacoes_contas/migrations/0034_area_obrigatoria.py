...
```sql
SELECT count(*) FROM prestacoes_contas_prestacaocontas WHERE area_id IS NULL;
```
...
**Volta:** `migrate prestacoes_contas 0033_prazo_de_saque_e_km_ordenados`. Nenhum dado muda.
"""
