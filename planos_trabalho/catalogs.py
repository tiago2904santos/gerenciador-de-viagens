...
ATIVIDADES = CatalogConfig(
    ...
    url_editar="planos_trabalho:atividade_editar",
    url_excluir="planos_trabalho:atividade_excluir",
...
PRESETS = CatalogConfig(
    ...
    url_editar="planos_trabalho:preset_editar",
    url_excluir="planos_trabalho:preset_excluir",
...
PROGRAMAS = CatalogConfig(
    ...
    url_editar="planos_trabalho:programa_editar",
    url_excluir="planos_trabalho:programa_excluir",
...
HORARIOS = CatalogConfig(
    ...
    url_editar="planos_trabalho:horario_editar",
    url_excluir="planos_trabalho:horario_excluir",
