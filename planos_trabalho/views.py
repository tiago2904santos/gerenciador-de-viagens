...
from .catalog_views import atividades_index
from .catalog_views import horario_editar
from .catalog_views import horario_excluir
from .catalog_views import horarios_index
from .catalog_views import preset_definir_padrao
from .catalog_views import preset_editar
from .catalog_views import preset_excluir
from .catalog_views import presets_index
from .catalog_views import programa_editar
from .catalog_views import programa_excluir
from .catalog_views import programas_index
