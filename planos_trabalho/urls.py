...
urlpatterns = [
    ...
    path("programas/novo/", views.programas_index, name="programa_novo"),
    ...
    path("horarios/novo/", views.horarios_index, name="horario_novo"),
    ...
    path("presets/<int:pk>/editar/", views.preset_editar, name="preset_editar"),
    path("presets/<int:pk>/padrao/", views.preset_definir_padrao, name="preset_definir_padrao"),
    path("presets/<int:pk>/excluir/", views.preset_excluir, name="preset_excluir"),
