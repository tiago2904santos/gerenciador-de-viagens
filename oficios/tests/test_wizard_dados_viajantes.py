...
class OficioWizardDadosViajantesTests(TestCase):
    ...
    def test_get_novo_renderiza_wizard(self):
        ...
        self.assertContains(response, "cv-search-picker-termos-field")
        ...
        self.assertContains(response, "js/components/cv-search-picker.js")
        ...
        self.assertContains(response, "cv-search-picker__native")
        self.assertContains(response, 'data-placeholder="Digite nome, RG ou CPF"')
        self.assertContains(response, 'data-picker-mode="compact"')
