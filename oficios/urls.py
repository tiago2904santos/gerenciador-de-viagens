...
urlpatterns = [
    ...
    path("modelos-motivo/novo/", views.modelos_motivo_index, name="modelo_motivo_create"),
    path("modelos-motivo/<int:pk>/editar/", views.modelo_motivo_editar, name="modelo_motivo_update"),
    path(
    ...
    path("<int:pk>/retificar/", views.retificar, name="retificar"),
    path("<int:pk>/complementar/", views.marcar_complementar, name="marcar_complementar"),
]
