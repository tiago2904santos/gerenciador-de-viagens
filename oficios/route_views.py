...
from roteiros.services import carregar_opcoes_rotas_avulsas_salvas, montar_contexto_editor_roteiro, normalizar_destinos_e_trechos_apos_erro_post, preparar_estado_editor_roteiro_para_get, preparar_querysets_formulario_roteiro, validar_submissao_editor_roteiro
